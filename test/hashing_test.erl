...
official_vectors_test_() ->
	Pattern = <<
		    0, 1, 2, 3, 4, 5, 6, 7, 16#FF, 16#7F, 16#3F, 16#1F, 16#0F, 8, 16, 32, 64, 16#80, 16#FE,
		    16#FC, 16#F8, 16#F0, 16#E0, 16#C0, 16#FD, 16#FB, 16#F7, 16#EF, 16#DF, 16#BF, 16#55, 16#AA,
		    11, 17, 19, 23, 29, 37, 42, 43, $a, $b, $c, $d, $e, $f, $g, $h, $i,
		    $j, $k, $l, $m, $n, $o, $p, $q, $r, $s, $t, $u, $v, $w, $x
		  >>,

	Vectors = [
	16#6A580668D6048674, 16#A2FE904AFF0D0879, 16#E3AB9C06FAF4D023, 16#6AF1C60874C95442,
	16#B3557E561A6C5D82, 16#0AE73C696F3D37C0, 16#5EF25F7062324941, 16#9B784F3B4CE6AF33,
	16#6993BB206A74F070, 16#F1E95DF109076C4C, 16#4E1EB70C58E48540, 16#5FDD7649D8EC44E4,
	16#559122C706343421, 16#380133D58665E93D, 16#9CE74296C8C55AE4, 16#3556F9A5757AB6D0,
	16#F62751F7F25C469E, 16#851EEC67F6516D94, 16#ED463EE3848A8695, 16#DC8791FEFF8ED3AC,
	16#2569C744E1A282CF, 16#F90EB7C1D70A80B9, 16#68DFA6A1B8050A4C, 16#94CCA5E8210D2134,
	16#F5CC0BEABC259F52, 16#40DBC1F51618FDA7, 16#0807945BF0FB52C6, 16#E5EF7E09DE70848D,
	16#63E1DF35FEBE994A, 16#2025E73769720D5A, 16#AD6120B2B8A152E1, 16#2A71D9F13959F2B7,
	16#8A20849A27C32548, 16#0BCBC9FE3B57884E, 16#0E028D255667AEAD, 16#BE66DAD3043AB694,
	16#B00E4C1238F9E2D4, 16#5C54BDE5AE280E82, 16#0E22B86754BC3BC4, 16#016707EBF858B84D,
	16#990015FBC9E095EE, 16#8B9AF0A3E71F042F, 16#6AA56E88BD380564, 16#AACE57113E681A0F,
	16#19F81514AFA9A22D, 16#80DABA3D62BEAC79, 16#715210412CABBF46, 16#D8FA0B9E9D6AA93F,
	16#6C2FC5A4109FD3A2, 16#5B3E60EEB51DDCD8, 16#0A7C717017756FE7, 16#A73773805CA31934,
	16#4DBD6BB7A31E85FD, 16#24F619D3D5BC2DB4, 16#3E4AF35A1678D636, 16#84A1A8DF8D609239,
	16#359C862CD3BE4FCD, 16#CF3A39F5C27DC125, 16#C0FF62F8FD5F4C77, 16#5E9F2493DDAA166C,
	16#17424152BE1CA266, 16#A78AFA5AB4BBE0CD, 16#7BFB2E2CEF118346, 16#647C3E0FF3E3D241,
	16#0352E4055C13242E, 16#6F42FC70EB660E38, 16#0BEBAD4FABF523BA, 16#9269F4214414D61D,
	16#1CA8760277E6006C, 16#7BAD25A859D87B5D, 16#AD645ADCF7414F1D, 16#B07F517E88D7AFB3
	],

	% [Caption, Val, Seed]
	BasicTestVals = [{"empty-zero", <<>>, 0}, {"empty-all1", <<>>, 1 bsl 64 - 1}, {"bin64-zero", Pattern, 0}],
	BinTestVals = [ {lists:flatten(io_lib:format("bin~2..0w-1p~2..0w", [C, C band 63])), binary:part(Pattern, {0, C}), 1 bsl (C-1)} || C <- lists:seq(1,63)],
	AlignTestVals = [ {lists:flatten(io_lib:format("align~b_F~b", [C, 64 - C])), binary:part(Pattern, {C, size(Pattern) - C}), t1ha:lo((1 bsl 64 -1) bsl C)} || C <- lists:seq(1,7)],

	Tests = lists:zip(BasicTestVals ++ BinTestVals ++ AlignTestVals, [0 | Vectors]),

	[
		{
			Caption,
			fun() -> ?assertEqual(<<Hash:64/big>>, t1ha:hash(Val, Seed)) end
		} || {{Caption, Val, Seed}, Hash} <- Tests
	].
